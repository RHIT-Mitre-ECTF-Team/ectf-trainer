...
#define GPIODEN2 *((unsigned int *) (GPIO_PORT_B_BASE + 0x51C))
#define GPIOAFSEL2 *((unsigned int *) (GPIO_PORT_B_BASE + 0x420))
#define GPIOPCTL2 *((unsigned int *) (GPIO_PORT_B_BASE + 0x52C))
